        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
          <div className="space-y-6">
            ...
            <div className="space-y-3 rounded-[2rem] border border-black/10 bg-black/5 p-8">
              <p className="text-xs sm:text-sm uppercase tracking-[0.35em] text-red-accent">Studio information</p>
              <p className="text-xs sm:text-sm leading-7 text-slate-700">hello@rankleather.example</p>
              <p className="text-xs sm:text-sm leading-7 text-slate-700">+1 (212) 555-0198</p>
              <p className="text-xs sm:text-sm leading-7 text-slate-700">25 Mercer Street, New York, NY</p>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          ...
          <div className="mt-10 overflow-hidden rounded-[2rem] border border-black/10 shadow-lg">
            ...
            <div className="p-6 bg-white text-slate-700">
              <p className="text-xs sm:text-sm uppercase tracking-[0.35em] text-red-accent">Map</p>
              <p className="mt-3 text-xs sm:text-sm lg:text-base leading-7">RANK Atelier is located in an intimate studio setting near downtown, designed for client consultations and bespoke product appointments.</p>
            </div>
          </div>
        </div>
      </section>
